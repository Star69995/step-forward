...
const SegmentedToggle = ({ options, value, onChange, className = "" }) => (
    <div role="radiogroup" className={`inline-flex items-center gap-1 bg-gray-100 rounded-lg p-1 ${className}`}>
            ...
            return (
                <button
                    ...
                    className={[
                        ...
                        active ? "bg-white text-primary shadow-xs" : "text-gray-600 hover:text-gray-800",
                    ].join(" ")}
                >
